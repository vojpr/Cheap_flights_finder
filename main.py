# Sign up form here: https://replit.com/@VojtechPrusa/Flight-Deals-Finder#main.py
...
for destination_code in destinations:
    ...
    if flight.price < destinations[destination_code]["price"]:
        ...
        message = f"Low price alert! Only {flight.price} CZK to fly from {flight.origin_city}-{flight.origin_airport}" \
